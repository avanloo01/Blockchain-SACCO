...
class Settings:
    ...
    payment_provider: str = os.getenv("PAYMENT_PROVIDER", "moonpay")
    ...
    moonpay_api_key: str = os.getenv("MOONPAY_API_KEY", "")
    moonpay_secret_key: str = os.getenv("MOONPAY_SECRET_KEY", "")
    moonpay_wallet_address: str = os.getenv("MOONPAY_WALLET_ADDRESS", "") or os.getenv("SOLANA_TREASURY_ADDRESS", "")
    moonpay_currency_code: str = os.getenv("MOONPAY_CURRENCY_CODE", "usdc_sol")
    moonpay_network: str = os.getenv("MOONPAY_NETWORK", "solana")
